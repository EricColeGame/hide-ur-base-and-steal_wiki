...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    title: { default: "Hide ur Base and Steal Wiki", template: "%s" },
    description: "Complete Hide ur Base and Steal fan wiki with codes, pets, secret bases, guides and stealing walkthroughs on Roblox.",
